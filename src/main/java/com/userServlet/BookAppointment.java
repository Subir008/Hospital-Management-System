...
public class BookAppointment extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Appointment appointment = new Appointment(user_id, doc_id, full_name, gender, age, email, contact,
				appointment_date, disease, address, "Pending");
		...
		// Taking the data from Appontmentdao class i.e, if the operation is performed
		// it will send true
		try {
		...
		// If the data is true it will start bookingConfirmed session otherwise it will
		// throw error
		if (flag) {
