...
public class Register extends HttpServlet
{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException 
	{
		...
		// If the data come from UserDao class is true then it will enter the if block otherwise it will go to the else block
		if(flag)
		{
			//If the data inserted then session will start , message will show and redireect to login page
		...
		{
			//If the data is not inserted then another session will start , message will show and redireect to login page
