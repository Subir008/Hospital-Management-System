...
public class UserLogin extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			// Cheking first if there is user given data or not . After that checking user
			// given credential is present in the db or not .
			if (user != null) {

				// If the user data is present in db then start the session and store the user
				// data in the session and redirect to the index page.
