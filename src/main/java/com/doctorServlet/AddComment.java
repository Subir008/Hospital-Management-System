...
public class AddComment extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException 
	{
		...
		//Creating object of AppointmentDao Class and passing the connection to invoke its method
		...
		// Taking the value and passing to the AppointmentDao Class and taking its value in the boolean form
		try {
